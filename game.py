...
def exitMessage(window, value):
    ...
    window.blit(text1,(WIDTH//3,HEIGHT//3))
    window.blit(text2,(WIDTH//3,HEIGHT//2))
...
def introMessage(window):
    ...
    textMain = ["Welcome to the Slither Survival Game!", "How to play?"]
    textSub = ["Use the 4 arrows on your keyboard to move the snake.", "You can score points by eating the food items.", "When the snake eats an item, it gets longer.", "The game ends if the snake hits the borders or runs into it's own body.", "The final score depends on the total number of food items eaten by the snake."]
    ...
    for i in textMain:
        text = fontObj.render(i, True, (255, 255, 255))
